...
@section('content_header')
    ...
    <div class="row">
        ...
        <div class="col-md-5 card-header bg-secondary"><strong>Servicios solicitados :</strong></div>
                ...
                <div class="p-3 table-bordered">
                    ...
                    @else
                        <div class="row">
                            ...
                            <div class="col-sm-3"><input type="radio" name="nodo" value="1" checked> Sí </div>
                            <div class="col-sm-3"><input type="radio" name="nodo" value="0"> No </div>
                        </div>
                    @endif
                    <br>
                    ...
                    @else
                        <div class="row">
                            ...
                            <div class="col-sm-3"><input type="radio" name="vpn" value="1" checked> Sí </div>
                            <div class="col-sm-3"><input type="radio" name="vpn" value="0"> No </div>
                        </div>
                    @endif
                    <br>
                    ...
                    @else
                        <div class="row">
                            ...
                            <div class="col-sm-3"><input type="radio" name="ip" value="1" checked> Sí </div>
                            <div class="col-sm-3"><input type="radio" name="ip" value="0"> No</div>
                        </div>
                    @endif
                    <br>
                    ...
                    @else
                        <div class="row">
                            <div class="col-sm-5"><strong>Internet:</strong></div>
                            <div class="col-sm-3"><input type="radio" name="internet" value="1" checked> Sí </div>
                            <div class="col-sm-3"><input type="radio" name="internet" value="0"> No </div>
                        </div>
                    @endif
                </div>
        </div>
    ...
    <div class="row">
        <form action="{{ route('petition.store') }}" method="POST">
            ...
            <div class="col-md-6 pl-2">
                <div class="p-2 card-header bg-secondary">
                    <h6>Cuentas</h6>
                </div>
                <div class="p-4 table-bordered">
