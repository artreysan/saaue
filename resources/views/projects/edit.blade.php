    ...
    <div class="container">
            ...
            <div class="card-body p-5">
                <div class="row">
                    ...
                    <input class="col-md-8" type="text" id="full_name" name="full_name" placeholder="{{ $project->full_name }}" required>
                </div>
                <br>
                <div class="row">
                    <h6 class="col-md-2"><strong>Nombre corto:</strong></h6>
                    <input class="col-md-2" type="text" id="short_name" name="short_name" placeholder="{{ $project->short_name }}" required>
                </div>
                <br>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <input class="col-md-6" type="text" id="unit" name="unit" placeholder="{{ $project->unit }}" required>
                </div>
                <br>
                <div class="row">
